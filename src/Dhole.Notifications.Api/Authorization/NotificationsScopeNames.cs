namespace Dhole.Notifications.Api.Authorization;

internal static class NotificationsScopeNames
{
    public const string MessagesCreate = "notifications.messages.create";
